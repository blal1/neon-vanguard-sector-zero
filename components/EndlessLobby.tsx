    ...
    return (
        <div className="w-full h-full flex flex-col p-8 overflow-y-auto">
            ...
            <div className="border-b border-purple-500 pb-4 mb-6">
                ...
                <p className="text-purple-300/70 text-sm">{t('endlessLobby.description')}</p>
            </div>
            ...
            <div className="flex gap-6 flex-1">
                ...
                <div className="flex-1 flex flex-col gap-4">
                    ...
                    <div className="border border-purple-500/30 p-4 bg-black/50">
                        <h2 className="text-purple-400 font-bold mb-3 text-lg border-b border-purple-500/30 pb-2">{t('endlessLobby.selectPilot')}</h2>
                    ...
                    {selectedPilot && (
                        <div className="border border-purple-500/30 p-4 bg-black/50">
                            <h2 className="text-purple-400 font-bold mb-3 text-lg border-b border-purple-500/30 pb-2">{t('endlessLobby.selectModule')}</h2>
                            <div className="grid grid-cols-2 gap-2">
                ...
                <div className="w-96 flex flex-col gap-4">
                    ...
                    <div className="border border-blue-500/30 p-4 bg-black/50">
                        ...
                        <ul className="text-gray-300 text-sm space-y-2">
                            ...
                            <li>• <span className="text-yellow-400">{t('endlessLobby.freeUpgrade')}</span> {t('endlessLobby.everyWaves')}</li>
                    ...
                    <div className="border border-amber-500/30 p-4 bg-black/50">
                        ...
                        <div className="space-y-1 text-sm">
                            <div className="flex justify-between">
                                <span className="text-gray-400">{t('endlessLobby.highestWave')}</span>
                                <span className="text-white font-bold">{stats.endlessHighestWave || 0}</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-gray-400">{t('endlessLobby.highScore')}</span>
                                <span className="text-purple-400 font-bold">{stats.endlessHighScore || 0}</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-gray-400">{t('endlessLobby.runsCompleted')}</span>
